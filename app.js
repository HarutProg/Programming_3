...
var Navak = require("./Modules/class.boat.js")
var spawner = require("./Modules/class.Spawner.js")
...
for (var y = 0; y < matrix.length; y++) {
    for (var x = 0; x < matrix[y].length; x++) {
        ...
        if (matrix[y][x] == 1) {
            ...
            spawnerArr.push(new spawner(x,y,4));
        }
        else if (matrix[y][x] == 5) {
            boatArr.push(new Navak(x,y,5));
        }
    }
}
...
function drawserever() {
    ...
    for (var i in predatorArr) {
        ...
        spawnerArr[i].spawnKiller();
        spawnerArr[i].spawnGrassEater();
        spawnerArr[i].spawnGrass();
    }
